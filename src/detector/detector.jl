...
function Detector(
    ...
    haskey(detectors, String(name)) || throw(ArgumentError("unknown detector name $(repr(name))"))
    ...
    isfile(psd_path) || throw(ArgumentError("noise curve file not found: $(repr(psd_path))"))
