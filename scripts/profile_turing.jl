...
#   - src/redshift.jl:95        differential_comoving_volume.(z_grid, H0, Omega_m) broadcast
#   - src/importance.jl:36      luminosity_distance.(z, H0, Omega_m) per-sample broadcast
...
function _run(
    ...
    suite["stage"]["lumdist"] = @benchmarkable luminosity_distance.($z_samples, $H0_val, $Omega_m_val)
